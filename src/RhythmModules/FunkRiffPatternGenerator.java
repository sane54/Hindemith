                        ...
                        for (int barNum = 0; barNum < pieceLength-1; barNum++) {
                            jPattern.add("|");
                                ...
                                if(voice == 0) jPattern.add("A4s Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs");
                                        ...
                                        if (patternIndex == 1) jPattern.add("Rs C4s C4s A4s Rs Rs A4s Rs Rs A4s Rs Rs A4s C4s C4s C4s");
                                        if (patternIndex == 2) jPattern.add("Rs C4s C4s A4s Rs C4s A4s Rs Rs A4s Rs Rs A4s Rs C4s Rs");
                                        if (patternIndex == 3) jPattern.add("Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs Rs");
                                }
