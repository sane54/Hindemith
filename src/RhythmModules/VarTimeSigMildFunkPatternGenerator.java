                        ...
                        for (int barNum = 0; barNum < pieceLength; barNum++) { // for each bar
                            ...
                            while (beat <= measure) 	{                      //for each beat
                                   ...
                                   if (patternIndex == 0) jPattern.add("A4s Rs Rs Rs");   
                                    ...
                                    if (patternIndex == 4) jPattern.add("R4s R4s R4s R4s");
                                    if (patternIndex == 5) jPattern.add("R4s R4s C4s R4s");
                                    if (patternIndex == 6) jPattern.add("R4s C4s C4s R4s");
                                    if (patternIndex == 7) jPattern.add("R4s C4s C4s C4s");
                                    beat++;
