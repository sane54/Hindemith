 ...
 */
package RhythmModules;

import genericcounterpoint.RhythmModule;
                        ...
                        for (int barNum = 0; barNum < pieceLength; barNum++) { // for each bar
                            ...
                            while (beat <= measure) 	{                      //for each beat
                                    ...
                                    if (roll.nextInt(2)> 0) {
                                        ...
                                        else jPattern.add("A4s Rs C4s Rs");
                                    }
                                    else {
                                        if (roll.nextInt(4)> 0) jPattern.add(motifString);
                                        else {
                                                patternIndex = (roll.nextInt(16));
                                                if (patternIndex == 0) motifString = ("Rs Rs Rs Rs");
                                                if (patternIndex == 1) motifString = ("Rs Rs Rs C4s");
                                                if (patternIndex == 2) motifString = ("Rs Rs C4s Rs");
                                                if (patternIndex == 3) motifString = ("Rs Rs C4s C4s");
                                                if (patternIndex == 4) motifString = ("Rs C4s Rs Rs");
                                                if (patternIndex == 5) motifString = ("Rs C4s Rs C4s");
                                                if (patternIndex == 6) motifString = ("Rs C4s C4s Rs");
                                                if (patternIndex == 7) motifString = ("Rs C4s C4s C4s");
                                                if (patternIndex == 8) motifString = ("A4s Rs Rs Rs");
                                                if (patternIndex == 9) motifString = ("A4s Rs Rs C4s");
                                                if (patternIndex == 10) motifString = ("A4s Rs C4s Rs");
                                                if (patternIndex == 11) motifString = ("A4s Rs C4s C4s");
                                                if (patternIndex == 12) motifString = ("A4s C4s Rs Rs");
                                                if (patternIndex == 13) motifString = ("A4s C4s Rs C4s");
                                                if (patternIndex == 14) motifString = ("A4s C4s C4s Rs");
                                                if (patternIndex == 15) motifString = ("A4s C4s C4s C4s");
                                                if (patternIndex == 16) motifString = ("A4s Rs Rs Rs");   // you could rewrite the program where 
                                                if (patternIndex == 17) motifString = ("A4s Rs Rs C4s");  // every beginning of a quarter is accented
                                                if (patternIndex == 18) motifString = ("A4s Rs C4s Rs");
                                                if (patternIndex == 19) motifString = ("A4s Rs C4s C4s");
                                                if (patternIndex == 20) motifString = ("A4s C4s Rs Rs");
                                                if (patternIndex == 21) motifString = ("A4s C4s Rs C4s");
                                                if (patternIndex == 22) motifString = ("A4s C4s C4s Rs");
                                                if (patternIndex == 23) motifString = ("A4s C4s C4s C4s");
                                                jPattern.add(motifString);
                                                }
                                        }
                                    beat++;
